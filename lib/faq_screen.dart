                  ...
                  itemBuilder: (BuildContext context, int index){
                    return Padding(
                      ...
                      child: new Container(
                        ...
                        child:  ExpansionTile(
                          childrenPadding: EdgeInsets.only(top: 0,bottom: 20),
                          title: Container(
                            height: 50,
...
//                            SizedBox(width: 180.0,),
                                ...
                                /*  Expanded(
                                        child: GestureDetector(
                                            ...
                                            child:
                                                Container(child:
                                                Icon(Icons.arrow_drop_down_circle, color: Colors.yellowAccent,))
                                          ),
