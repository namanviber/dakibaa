               ...
               Container(
                   ...
                   decoration: BoxDecoration(
                       gradient: RadialGradient(
                           ...
                           colors: [Colors.white.withOpacity(0.1),Colors.black,Colors.black,],
                           stops: [0.0, 1,1]
                       ),
                     ...
                     children: <Widget>[
                       ...
                       Padding(
                         padding: EdgeInsets.only(
                             top: usernameError == null ? 0 : MediaQuery.of(context).size.height/10, left: 60),
                         child: new Container(
                             child: new Row(
                               children: [
                                 Text(
                       ...
                       Padding(
                         padding: const EdgeInsets.only(left: 50.0,top: 8.0,right: 50.0),
                         child: Container(
                           height: 45,
                           decoration: BoxDecoration(
                               color: AppTheme().color_white,
                       ...
                       Padding(
                         ...
                         child: GestureDetector(
                           ...
                           child: Container(
                               ...
                               //margin: EdgeInsets.only(top: 5.0,left: 80,right: 80),
                               child:Center(
                                 child: Text("Guest Sign In".toUpperCase(),style: TextStyle(
                                     fontFamily: 'Montserrat',fontSize: 20,color: AppTheme().color_white),),
                               ),
                           ),
                         ),
                       ...
                       Container(
                           ...
                           child: GestureDetector(
                             ...
                             child: Text("New User ? SignUp",
                               style: TextStyle(fontFamily: 'Montserrat',fontSize: 17.0,fontWeight: FontWeight.w400,color: Colors.white),),
                           ))
                     ],
                   ),
               ),
